...
export default () => (
  <ThemeProvider theme={theme}>
    <Centered style={{ height: "auto", width: "auto" }}>
      <Head title="Privacy" />
      <div style={{ marginRight: 300, marginLeft: 300 }}>
        ...
        <p>
          ...
          may be asked to enter your name, mailing address, credit card
        ...
        <p>
          ...
          a user places an order to maintain the safety of your personal
          information.
        </p>
        ...
        <p>
          ...
          site interactions in order to offer better site experiences and tools
          in the future. We may also use trusted third-party services that track
